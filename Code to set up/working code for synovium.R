# Testing functions (Synovium)

# Tidy spectronaut
df <- Tidy_Spectronaut(file_path = "C:/Users/hlajens2/Desktop/MS Data/KA_250620_Equine0411_Synovium_Report.tsv")
...
# Normalise
normalised_df <- Normalise_Data(filtered_df = filtered_df, method = "Quantile")
